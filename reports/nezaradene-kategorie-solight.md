...
|---|---|---|
| Elektro, Smart Home a osvetlenie > Viaczásuvkové > Klasické | Elektro, Smart Home a osvetlenie > Viacnásobné zásuvky a izolačný materiál | 43 |
| Elektro, Smart Home a osvetlenie > Jednozásuvkové > Jednozásuvkové 230V | Elektro, Smart Home a osvetlenie > Predlžovacie káble a vidlice | 29 |
| Elektro, Smart Home a osvetlenie > Výsuvné a vstavané zásuvky | Elektro, Smart Home a osvetlenie > Vypínače a nástenné zásuvky | 28 |
| Elektro, Smart Home a osvetlenie > Navíjacie bubny | Elektro, Smart Home a osvetlenie > Predlžovacie káble a vidlice | 24 |
| Elektro, Smart Home a osvetlenie > Viaczásuvkové > Ostatné | Elektro, Smart Home a osvetlenie > Viacnásobné zásuvky a izolačný materiál | 22 |
| TV, audio, video a foto technika > AV káble > Computer > USB | TV, audio, video a foto technika > AV káble | 22 |
| Energia a napájanie > Napájacie zdroje > USB adaptéry | Počítače, mobily a tablety > Nabíjačky pre mobily | 21 |
| Elektro, Smart Home a osvetlenie > Prepäťové ochrany | Elektro, Smart Home a osvetlenie > Ističe a chrániče | 13 |
| Dielňa, náradie a záhrada > Meracia technika > Multimetre a zkúšačky | Dielňa, náradie a záhrada > Meracia technika > Multimetre a kliešťové merače | 13 |
| Elektro, Smart Home a osvetlenie > Záhradné stĺpiky | Elektro, Smart Home a osvetlenie > Predlžovacie káble a vidlice | 11 |
...
| TV, audio, video a foto technika > AV káble > Anténa > Anténne káble > COAX | TV, audio, video a foto technika > Antény a satelity | 6 |
...
| TV, audio, video a foto technika > AV káble > Anténa > Konektory a redukcie > COAX | TV, audio, video a foto technika > Antény a satelity | 2 |
