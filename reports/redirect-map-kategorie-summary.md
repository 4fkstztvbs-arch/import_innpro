...
- `reports/redirect-map-kategorie-shoptet-import.csv` – formát pripravený na import do Shoptet **Marketing → Základné SEO → Presmerovanie adries (URL)** (`fromUrl;toUrl;automatic`, relatívne cesty s lomítkom na konci).
